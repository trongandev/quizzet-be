...
const { addSubOutline, getSubOutline, getSubOutlineBySlug, deleteSubOutline, updateSO, updateViewSO, getSubOutlineByUser } = require("../controllers/subjectOutlineController");
